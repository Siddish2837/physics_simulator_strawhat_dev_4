...
const SCHEMA_TEMPLATE = Object.freeze({
    ...
    mass: null, time: null, distance: null, displacement: null,
    ...
    collision: { type: null, masses: [], velocities_before: [], velocities_after: [], impulse: null },
    ...
    relativity: { velocity: null, time_dilation: null, length_contraction: null },
...
function ensureArrays(p) {
    const paths = [['collision', 'masses'], ['collision', 'velocities_before'], ['collision', 'velocities_after'], ['formulas', 'equations']];
